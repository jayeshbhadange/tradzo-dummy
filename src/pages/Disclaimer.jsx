      ...
      <div className="mx-auto text-justify xl:mx-20 2xl:mx-32 px-4 sm:px-6 lg:px-16 py-4 sm:py-6 md:py-8">
        ...
        <div className="space-y-5 text-justify">
          ...
          <p>
            ...
            report is not to be construed as an offer to sell or the
            solicitation of an offer to buy any security in any jurisdiction
            where such an offer or solicitation would be illegal. It is for the
            general information of clients of Tradzo Technologies Private
            Limited. It does not constitute a personal recommendation or
          ...
          <p>
            ...
            regulatory, compliance or other reasons that prevent us from doing
            so. Prospective investors and others are cautioned that any
          ...
          <p>
            ...
            employees, Research Analyst(including relatives) worldwide may: (a)
            from time to time, have long or short positions in, and buy or sell
            the securities thereof, of company (ies) mentioned herein or (b) be
            engaged in any other transaction involving such securities and earn
            brokerage or other compensation or act as a market maker in the
            financial instruments of the subject company/companies discussed
            herein or act as advisor or lender / borrower to such company (ies)
            or have other potential/material conflict of interest with respect
            to any recommendation and related information and opinions at the
            time of publication of Research Report or at the time of public
            appearance. Tradzo Technologies Private Limited may have a
            proprietary long/short position in the above-mentioned scrip(s) and
            therefore may be considered as interested. The views provided herein
            are general in nature and do not consider the risk appetite or
            investment objective of particular investor; readers are requested
            to take independent professional advice before investing. This
            should not be construed as an invitation or solicitation to do
            business with Tradzo. Tradzo Technologies Private Limited does not
            provide any promise or assurance of favorable view for a particular
            industry or sector or business group in any manner. The investor is
            requested to take into consideration all the risk factors including
            their financial condition, suitability to risk return profile and
            take professional advice before investing, our research
            recommendations are standardized based on back-tested strategies and
            given with Stop-loss. All these recommendations are based on the
            probability of success. Every recommendation has a somewhat
            probability of failure, thus investor must follow stop-loss to avoid
            uncomfortable loss scenarios.
          </p>
          <p>
            The analyst for this report certifies that all the views expressed
            in this report accurately reflect his or her personal views about
            the subject company or companies and its or their securities, and no
          ...
          <p>
            We may have received compensation from the subject company(ies) in
          ...
          <p>
            ...
            or merchant banking or brokerage services from the subject
            company(ies) in the past 12 months. We or our associates may have
            received compensation or other benefits from the subject
            company(ies) or third party in connection with the research report.
            Our associates may have financial interest in the subject
            company(ies).
          </p>
          <p>
          ...
          <p>
            ...
            subject company(ies) at the end of the month immediately preceding
          ...
          <p>
            ...
            ownership of 1% or more securities of the subject company(ies) at
            the end of the month immediately preceding the date of publication
            of Research Report: No.
          </p>
          <p>
            Tradzo Technologies Private Limited has actual/beneficial ownership
            of 1% or more securities of the subject company(ies) at the end of
            the month immediately preceding the date of publication of Research
            Report: No
          </p>
          <p>
          ...
          <p>
            ...
            approach. The investor is requested to take into consideration all
            the risk factors including their financial condition, suitability to
            risk return profile and the like and take professional advice before
            investing.
          </p>
          <p>
          ...
          <p>
            ...
            actually trading in derivative contracts. Compliance Officer
            Details: Mrs. Shweta Patel. Call: 079 - 4039 1464, or Email:{" "}
          ...
          <p>
            Tradzo Technologies Private Limited. Registered Office: A-416
            SUMEL11, NAMASTE CIRCLE, SHAHIBAUG, AHMEDABAD, GUJARAT 380004. CIN:
            , Telephone No.: +079 40391464. Website:{" "}
